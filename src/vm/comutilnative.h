...
public:
    ...
    static FCDECL6(void,    GetMemoryInfo, UINT32* highMemLoadThreshold, UINT64* totalPhysicalMem, UINT64* hardLimit, UINT32* lastRecordedMemLoad, size_t* lastRecordedHeapSize, size_t* lastRecordedFragmentation);
    static FCDECL1(void,    GetConfigInfo, UINT32* heapCount);
